...
class DietCategories3Page extends StatefulWidget {
  const DietCategories3Page({super.key});

  static MaterialPageRoute route() {
    return MaterialPageRoute(
      builder: (context) => const DietCategories3Page(),
    );
  }

  @override
  State<DietCategories3Page> createState() => _DietCategories3PageState();
}

class _DietCategories3PageState extends State<DietCategories3Page> {
  bool _value = false;
              ...
              children: [
                const Positioned(
                  ...
                  child: AspectRatio(
                    ...
                    child: Image(
                        fit: BoxFit.cover,
                        image: AssetImage(AppImage.breakfast3)),
                  ),
                ),
                Positioned(
                  left: 0,
